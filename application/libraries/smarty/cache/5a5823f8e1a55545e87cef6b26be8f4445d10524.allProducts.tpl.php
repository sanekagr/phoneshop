...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_55aa40a76c9fb8_77360542',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa40a76c9fb8_77360542')) {function content_55aa40a76c9fb8_77360542($_smarty_tpl) {?><div class="container">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12">
                ...
                <button class="btn btn-primary" onclick="window.location='http://localhost/phoneshop/cms/dashboard/add_product/' ">
                    <i class="fa fa-plus"></i> Add new product
                </button>&nbsp;&nbsp;&nbsp;

                <button class="btn btn-info" onclick="window.location='http://localhost/phoneshop/cms/categories/' "><i class="fa fa-pencil"></i> Edit Categories
                </button>&nbsp;&nbsp;&nbsp;

                <button class="btn btn-default" onclick="window.location='http://localhost/phoneshop/cms/dashboard/database_backup/' "><i class="fa fa-download"></i> Database Backup
                </button>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 ">
            ...
            <form action="http://localhost/phoneshop/cms/dashboard/search_products" method="post" accept-charset="utf-8" id="search-products-form" role="search"><div style="display:none">
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <table class="table table-hover table-condensed table-products">
                    <tbody>
                                            <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/phones/phones-1">Apple iPhone 6</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/1' "><i
    ...
    <div class="modal-content" style="background:#E0E0E0; opacity: 0.9;">
      ...
      <div class="modal-footer">
        ...
        <button type="button" data-id="1" class="btn btn-danger delete-btn delete-product">Yes</button>
                                                ...
                                                <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/phones/phones-2">Samsung Galaxy S5</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/2' "><i
                                            class="fa fa-pencil"></i> Edit
                                </button>
                            </td>
                            <td class="col-xs-1">
    ...
    <div class="modal-content" style="background:#E0E0E0; opacity: 0.9;">
      ...
      <div class="modal-footer">
        ...
        <button type="button" data-id="2" class="btn btn-danger delete-btn delete-product">Yes</button>
                                                ...
                                                <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/phones/phones-70">Samsung Galaxy S6</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/70' "><i
                                            class="fa fa-pencil"></i> Edit
                                </button>
                            </td>
                            <td class="col-xs-1">
    ...
    <div class="modal-content" style="background:#E0E0E0; opacity: 0.9;">
      ...
      <div class="modal-footer">
        ...
        <button type="button" data-id="70" class="btn btn-danger delete-btn delete-product">Yes</button>
                                                ...
                                                <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/phones/phones-71">LG G3</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/71' "><i
                                            class="fa fa-pencil"></i> Edit
                                </button>
                            </td>
                            <td class="col-xs-1">
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <table class="table table-hover table-condensed table-products">
                    <tbody>
                                            <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/tablets/tablets-3">Apple iPad Air 2</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/3' "><i
                                            class="fa fa-pencil"></i> Edit
                                </button>
                            </td>
                            <td class="col-xs-1">
    ...
    <div class="modal-content" style="background:#E0E0E0; opacity: 0.9;">
      ...
      <div class="modal-footer">
        ...
        <button type="button" data-id="3" class="btn btn-danger delete-btn delete-product">Yes</button>
                                                ...
                                                <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/tablets/tablets-4">Apple iPad mini 3</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/4' "><i
                                            class="fa fa-pencil"></i> Edit
                                </button>
                            </td>
                            <td class="col-xs-1">
    ...
    <div class="modal-content" style="background:#E0E0E0; opacity: 0.9;">
      ...
      <div class="modal-footer">
        ...
        <button type="button" data-id="4" class="btn btn-danger delete-btn delete-product">Yes</button>
                                                ...
                                                <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/tablets/tablets-72">Samsung Galaxy Tab S 10.5</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/72' "><i
                                            class="fa fa-pencil"></i> Edit
                                </button>
                            </td>
                            <td class="col-xs-1">
    ...
    <div class="modal-content" style="background:#E0E0E0; opacity: 0.9;">
      ...
      <div class="modal-footer">
        ...
        <button type="button" data-id="72" class="btn btn-danger delete-btn delete-product">Yes</button>
                                                ...
                                                <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/tablets/tablets-73">Samsung Galaxy Tab 4 10.1 T530</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/73' "><i
                                            class="fa fa-pencil"></i> Edit
                                </button>
                            </td>
                            <td class="col-xs-1">
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <table class="table table-hover table-condensed table-products">
                    <tbody>
                                            <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/memory_cards/memory_cards-67">SanDisk Ultra microSDHC 32gb</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/67' "><i
                                            class="fa fa-pencil"></i> Edit
                                </button>
                            </td>
                            <td class="col-xs-1">
    ...
    <div class="modal-content" style="background:#E0E0E0; opacity: 0.9;">
      ...
      <div class="modal-footer">
        ...
        <button type="button" data-id="67" class="btn btn-danger delete-btn delete-product">Yes</button>
                                                ...
                                                <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/memory_cards/memory_cards-68">SanDisk Ultra SDHC/SDXC Memory Card 32gb</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/68' "><i
                                            class="fa fa-pencil"></i> Edit
                                </button>
                            </td>
                            <td class="col-xs-1">
    ...
    <div class="modal-content" style="background:#E0E0E0; opacity: 0.9;">
      ...
      <div class="modal-footer">
        ...
        <button type="button" data-id="68" class="btn btn-danger delete-btn delete-product">Yes</button>
                                                ...
                                                <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/memory_cards/memory_cards-69">SanDisk Extreme PRO CompactFlash 64gb</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/69' "><i
                                            class="fa fa-pencil"></i> Edit
                                </button>
                            </td>
                            <td class="col-xs-1">
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <table class="table table-hover table-condensed table-products">
                    <tbody>
                                            <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/cameras/cameras-6">Canon 600d</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/6' "><i
                                            class="fa fa-pencil"></i> Edit
                                </button>
                            </td>
                            <td class="col-xs-1">
    ...
    <div class="modal-content" style="background:#E0E0E0; opacity: 0.9;">
      ...
      <div class="modal-footer">
        ...
        <button type="button" data-id="6" class="btn btn-danger delete-btn delete-product">Yes</button>
                                                ...
                                                <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/cameras/cameras-8">Sony Alpha a7s</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/8' "><i
                                            class="fa fa-pencil"></i> Edit
                                </button>
                            </td>
                            <td class="col-xs-1">
    ...
    <div class="modal-content" style="background:#E0E0E0; opacity: 0.9;">
      ...
      <div class="modal-footer">
        ...
        <button type="button" data-id="8" class="btn btn-danger delete-btn delete-product">Yes</button>
                                                ...
                                                <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/cameras/cameras-74">Samsung NX1</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/74' "><i
                                            class="fa fa-pencil"></i> Edit
                                </button>
                            </td>
                            <td class="col-xs-1">
    ...
    <div class="modal-content" style="background:#E0E0E0; opacity: 0.9;">
      ...
      <div class="modal-footer">
        ...
        <button type="button" data-id="74" class="btn btn-danger delete-btn delete-product">Yes</button>
                                                ...
                                                <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/cameras/cameras-75">Nikon D5500</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/75' "><i
                                            class="fa fa-pencil"></i> Edit
                                </button>
                            </td>
                            <td class="col-xs-1">
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <table class="table table-hover table-condensed table-products">
                    <tbody>
                                            <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/phone_accessories/accessories-5">headphones apple</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/5' "><i
                                            class="fa fa-pencil"></i> Edit
                                </button>
                            </td>
                            <td class="col-xs-1">
    ...
    <div class="modal-content" style="background:#E0E0E0; opacity: 0.9;">
      ...
      <div class="modal-footer">
        ...
        <button type="button" data-id="5" class="btn btn-danger delete-btn delete-product">Yes</button>
                                                ...
                                                <tr>
                            <td class="col-xs-4"><a
                                        href="http://localhost/phoneshop/products/phone_accessories/accessories-7">Charger Micro Usb</a>
                            </td>
                            <td class="col-xs-1">
                                <button class="btn btn-info pull-right"
                                        onclick="window.location='http://localhost/phoneshop/cms/dashboard/edit_product/7' "><i
                                            class="fa fa-pencil"></i> Edit
                                </button>
                            </td>
                            <td class="col-xs-1">
